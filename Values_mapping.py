...
class VariableValues():
    ...
    discrete_setting_Y_0 = set_discrete_range_and_bounds(lower_bond=8000., upper_bond=16000., bins_num=18, round_by=0)
    discrete_setting_Y_1 = set_discrete_range_and_bounds(lower_bond=18.7, upper_bond=19.3, bins_num=14, round_by=3)
    discrete_setting_W = set_discrete_range_and_bounds(lower_bond=0.02, upper_bond=0.16, bins_num=16, round_by=4)
    discrete_setting_V_1 = set_discrete_range_and_bounds(lower_bond=420, upper_bond=760, bins_num=19, round_by=0)
